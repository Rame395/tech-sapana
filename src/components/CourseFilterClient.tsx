...
export default function CourseFilterClient({ courses }: { courses: Course[] }) {
  ...
  return (
    <>
      ...
      <div className="sticky top-[80px] z-30 bg-white/80 dark:bg-bg-primary/80 backdrop-blur-xl border-b border-gray-200 dark:border-white/10 shadow-sm py-3 mb-12">
