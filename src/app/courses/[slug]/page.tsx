...
export default function CourseDetails() {
  return (
    <>
        ...
        <section className="relative pt-24 pb-16 bg-bg-primary overflow-hidden">
          <div className="w-full max-w-[1240px] mx-auto px-6 relative z-10">
            ...
            <div className="flex items-center gap-2 text-sm font-semibold text-text-muted mb-8">
              ...
              <span>/</span>
              <span className="text-text-main">Applied AI</span>
              <span>/</span>
              <span className="text-text-main">AI for Life &amp; Business</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.12em] uppercase text-brand-blue mb-4 bg-brand-blue-soft px-3 py-1.5 rounded-full border border-border-accent">
                  4-WEEK INTENSIVE PROGRAM • BATCH 04
                </div>
                ...
                <p className="text-lg text-text-muted mb-8 max-w-xl leading-relaxed">
                  Master prompt engineering, configure custom AI agents, and
                  automate operational workflows without writing code. Taught by
              ...
              <div className="relative">
                <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-border-medium aspect-[4/3] bg-black group">
                  <img
                    src="https://images.unsplash.com/photo-1677442136019-21780efad99a?auto=format&amp;fit=crop&amp;w=900&amp;q=80"
                    alt="AI Course Visual Preview"
                  ...
                  <div className="absolute bottom-4 right-4 bg-bg-card/90 backdrop-blur-md border border-border-subtle p-3 rounded-lg shadow-lg flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <div className="text-sm font-bold text-text-main">Starting This Wednesday</div>
                      <div className="text-xs text-text-muted">Only 4 seats remaining</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="sticky top-[80px] z-40 bg-bg-secondary/90 backdrop-blur-md border-y border-border-subtle">
          <div className="w-full max-w-[1240px] mx-auto px-6">
            <ul className="flex items-center gap-8 overflow-x-auto whitespace-nowrap py-4">
              <li>
                <a href="#overview" className="text-sm font-bold text-brand-blue border-b-2 border-brand-blue pb-4">
                  Overview
                </a>
              </li>
              <li>
                <a href="#curriculum" className="text-sm font-semibold text-text-muted hover:text-text-main transition-colors pb-4">
                  Syllabus
                </a>
              </li>
              <li>
                <a href="#tools" className="text-sm font-semibold text-text-muted hover:text-text-main transition-colors pb-4">
                  Tools Stack
                </a>
              </li>
              <li>
                <a href="#instructor" className="text-sm font-semibold text-text-muted hover:text-text-main transition-colors pb-4">
                  Instructor
                </a>
              </li>
            </ul>
              ...
              <div className="flex flex-col gap-16">
                ...
                <div id="overview" className="scroll-mt-32">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {[
                      { title: "Custom GPT Agents", desc: "Build specialized bots loaded with company data." },
                      { title: "No-Code Automation", desc: "Connect Gmail, Slack, and Sheets to AI webhooks." },
                      { title: "Prompt Frameworks", desc: "Structured 5-part method for precise research & copy." },
                      { title: "Operations Pipelines", desc: "Automate invoice parsing and client onboarding 24/7." }
                    ].map((item, i) => (
                      <div key={i} className="flex gap-4 p-6 bg-bg-secondary border border-border-subtle rounded-xl hover:border-brand-blue hover:-translate-y-1 transition-all duration-300 shadow-sm">
                        ...
                        <div>
                          <div className="font-bold text-text-main mb-1">{item.title}</div>
                ...
                <div id="curriculum" className="scroll-mt-32">
                  <h2 className="text-3xl font-extrabold text-text-main mb-8">4-Week Program Syllabus</h2>
                  <div className="flex flex-col gap-4">
                    {[
                      { week: "WEEK 01", title: "Foundations of AI & Advanced Prompt Engineering", lessons: ["How modern LLMs process context, memory, and tokens.", "The 5-part structured prompt framework.", "Eliminating hallucinations & zero-shot vs few-shot prompt methods."] },
                      { week: "WEEK 02", title: "Building Custom AI Assistants & Knowledge Bases", lessons: ["Uploading PDF manuals, company policies, and business data.", "Custom instructions, tone configuration, and private GPT security.", "Creating internal support and customer-facing FAQ bots."] },
                      { week: "WEEK 03", title: "Autonomous Workflows & No-Code Automations", lessons: ["Connecting Google Sheets, Slack, and Gmail with Make.com & Zapier.", "Automated invoice extraction and data categorization.", "Triggering autonomous AI responses on incoming client inquiries."] },
                      { week: "WEEK 04", title: "Capstone Deployment & Commercial Workflows", lessons: ["Building your real-world business automation capstone.", "1-on-1 code and workflow audit with TechSapana engineers.", "Lifetime resource access, course certificate, and alumni community."] }
                    ].map((module, i) => (
                ...
                <div id="tools" className="scroll-mt-32">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {[
                      { icon: "⚡", name: "ChatGPT & GPT-4o", desc: "Core LLM Workflows" },
                      { icon: "🤖", name: "Custom GPTs", desc: "Specialized Agents" },
                      { icon: "🔄", name: "Make.com", desc: "Automation Webhooks" },
                      { icon: "⚡", name: "Zapier AI", desc: "Workflow Bridges" },
                      { icon: "🎨", name: "Midjourney", desc: "Visual Asset Generation" },
                      { icon: "📄", name: "Claude 3.5 Sonnet", desc: "Advanced Research" }
                    ].map((tool, i) => (
                ...
                <div id="instructor" className="scroll-mt-32">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 p-8 bg-bg-secondary border border-border-subtle rounded-xl">
                    <div className="w-32 h-32 flex-shrink-0 rounded-full overflow-hidden border-4 border-border-subtle">
                      <img
                    ...
                    <div className="flex flex-col justify-center">
                      <div className="text-xl font-bold text-text-main mb-1">Krish Jung Thapa &amp; Engineering Team</div>
                      <div className="text-sm font-semibold text-brand-blue mb-4">CEO &amp; Solutions Director, TechSapana</div>
                      <p className="text-text-muted text-sm leading-relaxed">
                        Active software architects with real-world experience building custom business systems and AI automations for clients across Nepal, Australia, and the US.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-bg-secondary border border-border-subtle rounded-2xl p-6 shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
                  <div className="flex justify-between items-end mb-6 pb-6 border-b border-border-subtle">
                    <div>
                      ...
                      <div className="text-3xl font-extrabold text-text-main">NPR 12,500</div>
                    </div>
                    <div className="text-sm font-semibold text-text-muted line-through">NPR 18,000</div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 mb-8">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-bold text-text-main">Wed, Sep 03</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-text-muted">Schedule:</span>
                      <span className="font-bold text-text-main">Mon, Wed, Fri</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-text-muted">Class Timing:</span>
                      <span className="font-bold text-text-main">7:00 – 8:30 PM NPT</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-text-muted">Remaining Seats:</span>
                      <span className="font-bold text-red-500">Only 4 Left</span>
                    </div>
                  </div>
      ...
      {/* Modal Overlay Placeholder (Hidden by default, normally controlled by state) */}
      {/* 
