  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/admin/portfolio/new" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2 font-bold shadow-lg shadow-blue-600/30 transition-all">
              ...
              projects.map((project) => (
                <tr key={project.id} className="hover:bg-white/5 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    <div className="text-sm text-gray-400 font-medium mt-1">{project.client || "No client"}</div>
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-300 capitalize font-medium">
                    {project.category}
                  </td>
                  <td className="px-6 py-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-bold tracking-wide ${
                      project.published ? "bg-green-500/20 text-green-400 border border-green-500/30" : "bg-white/10 text-gray-300 border border-white/20"
                    }`}>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-4">
                      <Link href={`/admin/portfolio/${project.id}`} className="text-blue-400 hover:text-blue-300 transition-colors bg-blue-400/10 p-2 rounded-lg hover:bg-blue-400/20">
                        <Edit size={18} />
                      </Link>
